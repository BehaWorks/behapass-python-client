...
class MovementRecord(object):
    ...
    def __init__(self, session_id=None, timestamp=None, controller_id=None, x=None, y=None, z=None, yaw=None, pitch=None, roll=None, r_x=None, r_y=None, r_z=None):  # noqa: E501
