...
class ButtonRecord(object):
    ...
    def __init__(self, session_id=None, timestamp=None, controller_id=None, trigger=None, trackpad_x=None, trackpad_y=None, button_pressed=None, button_touched=None, menu_button=None, trackpad_pressed=None, trackpad_touched=None, grip_button=None):  # noqa: E501
